...
int main(int argc, char* argv[]) {
    ...
    // === Li.Lj Li.Lj ===
    exc = JExch;
    ampo += exc,"Sx",N,"Sx",1, "Sx",N,"Sx",1;
    ampo += exc,"Sx",N,"Sx",1, "Sy",N,"Sy",1;
    ampo += exc,"Sx",N,"Sx",1, "Sz",N,"Sz",1;
    ampo += exc,"Sy",N,"Sy",1, "Sx",N,"Sx",1;
    ampo += exc,"Sy",N,"Sy",1, "Sy",N,"Sy",1;
    ampo += exc,"Sy",N,"Sy",1, "Sz",N,"Sz",1;
    ampo += exc,"Sz",N,"Sz",1, "Sx",N,"Sx",1;
    ampo += exc,"Sz",N,"Sz",1, "Sy",N,"Sy",1;
    ampo += exc,"Sz",N,"Sz",1, "Sz",N,"Sz",1;
    // exit(1);
