...
def main(total, cmdargs):
	...
	### -------- onsite observables -------------------
	filename="../Hz_"+Hz+"/runForinput.cout"	
	string="Sweep=12, HS=2, Bond=32/63"
	...
	vn_str = lines[matchindex]
	vn_str = vn_str.replace("    vN Entropy at center bond b=32 = ","")
	vn_str = vn_str.split(" ")
	vn = float(vn_str[0])

	outfile = open("vN.dat","a")
	outfile.write(str(vn)+" ")
	outfile.close()
